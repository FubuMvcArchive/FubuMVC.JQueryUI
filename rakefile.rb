...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.JQueryUI"
COPYRIGHT = 'Copyright 2012 FubuMVC.JQueryUI. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  bottles("assembly-pak src/FubuMVC.JQueryUI -p FubuMVC.JQueryUI.csproj")

  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.JQueryUI.sln', :clrversion => CLR_TOOLS_VERSION
